...
export const ConcludeFlip = () => {
  return (
    <>
      <Box bgColor="#fff" p={"40px 40px 0px 20px"} width="100%">
        <Box mb="20px">
          <Heading textAlign={"left"} fontSize="lg" color={"#878787"} mb={"20px"}>
            Top Stories:Brand Directory
          </Heading>
          <Text textAlign={"justify"} fontSize="xs" color={"#878787"}>
            TVS:Nokia TVPanasonic TVThomson TVVu TVRealme TVMotorola TVOnePlus
          ...
          <Text textAlign={"justify"} fontSize="xs" color={"#878787"}>
            BEST SELLING ON FLIPKART:Fire-Boltt Ninja Calling Pro Bluetooth
            Calling Smartwatch 1.69 inch HD Display SmartwatchBest Gas
            ...
            ClocksBaby FoodChocolatesCyclesCalculatorsLipsticksMaskVertiv
            UPSFastrack WatchesWalletsEarringsGold CoinsRealme Pad
            MiniHandbagsconekt SW2 SmartwatchMivi DuoPods a350Speaker Cleaner
          </Text>
          <Text textAlign={"justify"} fontSize="xs" color={"#878787"}>
            CLOTHING:Men ShirtsKurta PajamaKurtasMen
        ...
        <Box mb="20px">
          <Heading textAlign={"left"} fontSize="lg" color={"#878787"} mb="10px">
            Flipkart: The One-stop Shopping Destination
          </Heading>
          <Text textAlign={"justify"} fontSize="xs" color={"#878787"} mb="10px">
        ...
        <Box mb="20px">
          ...
          <Text textAlign={"justify"} fontSize="xs" color={"#878787"}>
            ...
            of exciting services, like: An annual Zomato Gold membership <br />
