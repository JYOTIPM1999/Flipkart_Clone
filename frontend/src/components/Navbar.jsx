...
const Navbar = () => {
  ...
  const handleChange = (e) => {
    ...
    axios.post("http://localhost:8090/tv/search", obj).then((res) => {
  ...
  const handlehidesearch = () => {
    axios
      .post("http://localhost:8090/tv/search", { str: "" })
        ...
        <Flex w={"80%"} m={"auto"} justifyContent={"space-between"}>
          <Flex w={"55%"} gap={"20px"} alignItems={"center"}>
            ...
            <InputGroup>
              ...
              />
              <InputRightElement
                children={<SearchIcon color="#2874f0" cursor={"pointer"} />}
              />
            </InputGroup>
          </Flex>
          <Flex justifyContent={"space-around"} w={"45%"} alignItems={"center"}>
            ...
            {/* <Text color={"whiteAlpha.900"} fontWeight={"bold"}> */}
            <Link to="/cart" color={"whiteAlpha.900"} fontWeight={"bold"}>
              Cart
            </Link>
            {/* </Text> */}
          </Flex>
          ...
          >
            {data.map((elem) => (
              <Box
                ...
                mt="4"
                cursor={"pointer"}
                _hover={{ backgroundColor: "rgb(40,116,240,.2)" }}
              >
                ...
                <Box>
                  ...
                  <Text fontSize={13} fontWeight="500" color="#639af4">
                    {elem.brand}
                  </Text>
                </Box>
              </Box>
